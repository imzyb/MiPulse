...
// .wrangler/tmp/bundle-Ug07PI/checked-fetch.js
...
// .wrangler/tmp/bundle-Ug07PI/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-81LD0k/functionsWorker-0.023793510063392587.mjs
...
async function loadSettings(env) {
  ...
  const row = await env.MIPULSE_DB.prepare("SELECT value FROM settings WHERE key = ?").bind(SETTINGS_KEY).first();
  if (!row?.value)
    return resolveSettings();
  let parsed = {};
  try {
...
// .wrangler/tmp/bundle-Ug07PI/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Ug07PI/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.023793510063392587.js.map
